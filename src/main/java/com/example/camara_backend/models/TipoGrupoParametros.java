...
@Entity
@Table(name = "tipo_grupo_parametros")
public class TipoGrupoParametros {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "id_tipo_grupo_parametros")
    private Long idTipoGrupoParametros;
    ...
    public TipoGrupoParametros() {
    }

    // Getters y Setters
    public Long getIdTipoGrupoParametros() {
        return idTipoGrupoParametros;
    }

    public void setIdTipoGrupoParametros(Long idTipoGrupoParametros) {
        this.idTipoGrupoParametros = idTipoGrupoParametros;
    }
